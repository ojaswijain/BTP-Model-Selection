...
n2 = 91 # v2 options
l1, l2, l3 = lambdas
l1_range = np.geomspace(l1*0.25, l1*4, 9) # l1 range
l2_range = np.geomspace(l2*0.25, l2*4, 9) # l2 range
l3_range = np.geomspace(l3*0.25, l3*4, 9) # l3 range
...
def generate_off_center_V():
    ...
    """
    V_true = generate_V()
    # Take each V to be the centroid of the triangles formed by the repulsion model
